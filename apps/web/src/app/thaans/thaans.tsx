          ...
          {rows.length > 0 && (
            <div className="mb-4 flex flex-none items-center gap-3">
              <input
                ...
                placeholder="Search by bale code, Thaan code, supplier, item, type, grade or invoice — comma- or space-separate several"
                ...
                <table className="w-full border-collapse whitespace-nowrap text-[13px]">
                  <thead className="sticky top-0 bg-surface-2">
                    <tr className="border-b border-rule text-left">
                      ...
                      <th scope="col" className="px-3 py-2 text-[11.5px] font-medium text-muted">Invoice</th>
                      <th scope="col" className="px-3 py-2 text-[11.5px] font-medium text-muted">Transporter</th>
                      <th scope="col" className="px-3 py-2 text-right text-[11.5px] font-medium text-muted">Bale total</th>
                      <th scope="col" className="px-3 py-2 text-right text-[11.5px] font-medium text-muted">Per Thaan</th>
                      <th scope="col" className="px-3 py-2 text-[11.5px] font-medium text-muted">2nd print</th>
                  ...
                  <tbody>
                    {pageRows.map((r) => (
                      ...
                      >
                        ...
                        <td className="px-3 text-ink-2">{r.transporter ?? "—"}</td>
                        <td className="px-3 text-right font-mono text-[12.5px] text-ink-2 tabular-nums">
                          {r.metresReceived} {r.uom}
                        </td>
                        <td className="px-3 text-right font-mono text-[12.5px] text-ink-2 tabular-nums">
                          {r.perThaanMetres ?? "—"}
                        </td>
                        <td className="px-3 text-ink-2">{r.needsSecondPrint ? "Yes" : "No"}</td>
                        <td
                          className="px-3 text-ink-2"
